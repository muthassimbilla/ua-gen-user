...
import { Smartphone, ArrowRight, Star, MapPin } from "lucide-react"
...
export default function ToolsPage() {
  return (
    <ProtectedRoute>
      <DashboardLayout title="UGen Pro Creative">
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-semibold">Recent Apps</h3>
                ...
                return (
                  <Card key={tool.name} className="group hover:shadow-lg transition-all duration-300">
                    <CardHeader className="pb-4">
                      ...
                      <p className="text-sm text-muted-foreground">{tool.features[0]}</p>
                    </CardHeader>
