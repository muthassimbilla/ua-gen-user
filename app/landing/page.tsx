  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        ...
        {/* Hero Section */}
        <section className="relative z-10 px-6 pt-20 pb-2">
          <div className="max-w-7xl mx-auto h-full">
            <div className="relative rounded-[3rem] overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 animate-float">
              {/* Clean Gradient Background - Similar to TaskHarbor */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-blue-900/30 dark:to-indigo-900/30" />

              {/* Subtle wave decoration at bottom */}
              <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white/40 to-transparent dark:from-slate-800/40 dark:to-transparent" />

              {/* Decorative gradient orbs */}
              <div className="absolute top-20 right-20 w-64 h-64 bg-gradient-to-br from-blue-200/40 to-purple-200/40 dark:from-blue-500/20 dark:to-purple-500/20 rounded-full blur-3xl animate-float" />
              <div
                className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-br from-indigo-200/30 to-pink-200/30 dark:from-indigo-500/15 dark:to-pink-500/15 rounded-full blur-3xl animate-float-reverse"
                style={{ animationDelay: "1s" }}
              />

              {/* Hero Content */}
              <div className="relative z-10 py-24 md:py-32 px-8 md:px-16">
                <div className="max-w-4xl mx-auto">
                  <div className="space-y-8 flex flex-col items-center text-center">
                    <div className="space-y-6 flex flex-col items-center">
                      <div className="inline-flex items-center space-x-3 px-6 py-3 rounded-full bg-gradient-to-r from-purple-200/95 to-pink-200/95 dark:from-purple-500/20 dark:to-pink-500/20 border-2 border-purple-400/80 dark:border-purple-500/30 text-purple-800 dark:text-purple-300 text-sm font-semibold shadow-lg backdrop-blur-md animate-pulse-glow hover:scale-105 transition-transform duration-300">
                        <div className="w-2 h-2 bg-purple-700 dark:bg-purple-400 rounded-full animate-pulse"></div>
                        <span>{t.hero.badge}</span>
                        <div
                          className="w-2 h-2 bg-pink-700 dark:bg-pink-400 rounded-full animate-pulse"
                          style={{ animationDelay: "0.5s" }}
                        ></div>
                      </div>

                      <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white leading-tight drop-shadow-2xl">
                        <div className="flex flex-col items-center space-y-2">
                          <span className="inline-block animate-text-shimmer text-slate-900 dark:text-white">
                            Premium Tools
                          </span>
                          <span className="inline-block text-slate-800 dark:text-slate-300 font-medium text-4xl md:text-6xl">
                            for
                          </span>
                          <span
                            id="animated-text"
                            className="bg-gradient-to-r from-purple-700 via-pink-700 to-blue-700 dark:from-purple-400 dark:via-pink-400 dark:to-blue-400 bg-clip-text text-transparent font-black text-4xl md:text-6xl animate-text-shimmer transition-all duration-300 ease-in-out drop-shadow-lg"
                            style={{
                              opacity: 1,
                      ...
                      <p className="text-xl text-slate-800 dark:text-slate-200 leading-relaxed max-w-2xl font-semibold drop-shadow-lg">
                        {t.hero.subtitle}
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                      ...
                      <Button
                        onClick={scrollToFeatures}
                        variant="outline"
                        className="px-10 py-6 rounded-2xl border-2 border-slate-700 dark:border-white/30 bg-white/90 dark:bg-white/10 hover:bg-white dark:hover:bg-white/20 backdrop-blur-md text-slate-900 dark:text-white text-xl font-bold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 transform"
                      >
              ...
              <div className="absolute top-10 right-10 w-32 h-32 bg-gradient-to-br from-blue-300/20 to-purple-300/20 dark:from-blue-500/10 dark:to-purple-500/10 rounded-full blur-2xl animate-float" />
              <div
                className="absolute bottom-10 left-10 w-40 h-40 bg-gradient-to-br from-pink-300/20 to-orange-300/20 dark:from-pink-500/10 dark:to-orange-500/10 rounded-full blur-2xl animate-float-reverse"
                style={{ animationDelay: "1s" }}
              />
            </div>
          </div>
        ...
        {/* Features Section */}
        <section id="features" className="relative z-10 px-6 pt-2 pb-12">
        ...
        {/* Pricing Section */}
        <section id="pricing" className="relative z-10 px-6 pt-4 pb-12">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 text-sm font-medium mb-6 animate-shimmer hover:scale-105 transition-transform duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {t.pricing.plans.map((plan, index) => (
                <Card
                  key={index}
                  className={`group relative overflow-hidden rounded-3xl transition-all duration-500 hover:-translate-y-3 hover:scale-[1.02] hover-lift animate-float h-full flex flex-col ${
                    plan.popular
        ...
        <section className="relative z-10 px-6 pt-4 pb-12">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 text-sm font-medium mb-6 animate-shimmer hover:scale-105 transition-transform duration-300">
        ...
        {/* Contact Section */}
        <section id="contact" className="relative z-10 pt-4 pb-12 px-6">
          <div className="max-w-4xl mx-auto">
        ...
        <footer className="relative z-10 py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <Card className="bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border-slate-200 dark:border-slate-700/50 shadow-2xl overflow-hidden hover-lift rounded-3xl">
              <CardContent className="p-0">
                {/* Main Footer Content */}
