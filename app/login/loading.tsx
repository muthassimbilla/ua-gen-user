      ...
      <Card className="w-full max-w-md mx-4 bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl border border-white/30 dark:border-slate-700/30 shadow-2xl">
        <CardContent className="p-8 text-center">
          <div className="relative mb-6">
            ...
            {/* Inner Ring */}
            <div className="absolute inset-2 w-12 h-12 border-4 border-purple-200 dark:border-purple-800 rounded-full animate-spin border-t-purple-600 dark:border-t-purple-400 mx-auto" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
          ...
          <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300 mb-2">Loading Login</h3>
          <p className="text-slate-500 dark:text-slate-400 mb-4">Preparing authentication...</p>
