    ...
    <section id="pricing" className="relative py-10 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div className={`mb-6 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br ${plan.gradient} bg-opacity-10 group-hover:scale-110 transition-transform duration-300`}>
                <plan.icon className={`h-7 w-7 bg-gradient-to-br ${plan.gradient} bg-clip-text text-transparent`} />
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-baseline">
                  <span className={`text-6xl font-bold bg-gradient-to-br ${plan.gradient} bg-clip-text text-transparent`}>
                    {plan.price}
                  </span>
                  <span className="text-muted-foreground ml-3 text-lg">/month</span>
                </div>
              </div>
        ...
        <div className="mt-8 text-center">
          ...
          <Button variant="outline" size="lg" className="hover:bg-primary/5 hover:border-primary transition-all duration-300">
            Contact Sales
          </Button>
        </div>
      </div>
